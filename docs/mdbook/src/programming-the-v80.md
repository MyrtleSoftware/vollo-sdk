...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v25.0.0/vollo-amd-v80-c6b32-25.0.tar.gz
mkdir -p $VOLLO_SDK/bitstream
tar -xzf vollo-amd-v80-c6b32-25.0.tar.gz -C $VOLLO_SDK/bitstream
```
