...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v27.0.1/vollo-ia840f-c2b64d-27.0.tar.gz
mkdir -p $VOLLO_SDK/bitstream
tar -xzf vollo-ia840f-c2b64d-27.0.tar.gz -C $VOLLO_SDK/bitstream
```
