 ...
 */
typedef const char* vollo_cfg_error_t;
 ...
 */
typedef uint32_t (*vollo_cfg_reader_t)(void* user_context, uint32_t addr);
 ...
 */
typedef void (*vollo_cfg_writer_t)(void* user_context, uint32_t addr, uint32_t dat);
