...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v25.1.0/vollo-ia840f-c2b64d-25.1.tar.gz
mkdir -p $VOLLO_SDK/bitstream
tar -xzf vollo-ia840f-c2b64d-25.1.tar.gz -C $VOLLO_SDK/bitstream
```
