...
/* Meta Information */
#define MDL_VERSION     "1.0.0-myrtle-fork"
#define MDL_DESCRIPTION "AVED Management Interface (AMI) is used to manage AVED-based devices through PCIe (Myrtle fork)"
