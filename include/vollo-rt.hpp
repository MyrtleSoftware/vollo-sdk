...
/// A context for performing computation on a vollo. You can construct a context with
/// `vollo_rt_init` and destroy it with `vollo_rt_destroy`.
...
using vollo_rt_model_t = const void*;
