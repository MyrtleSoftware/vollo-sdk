...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v26.2.0/vollo-ia840f-c2b64d-26.2.tar.gz
mkdir -p $VOLLO_SDK/bitstream
tar -xzf vollo-ia840f-c2b64d-26.2.tar.gz -C $VOLLO_SDK/bitstream
```
