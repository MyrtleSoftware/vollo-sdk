...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v28.1.2/vollo-silicom-artena-c8b32-28.1.tar.gz
...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v28.1.2/vollo-silicom-artena-c8b32lstm-28.1.tar.gz
mkdir -p $VOLLO_SDK/bitstream
