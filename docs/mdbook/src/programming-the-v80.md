...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v28.1.0/vollo-amd-v80-c6b32-28.1.tar.gz
...
```sh
curl -LO https://github.com/MyrtleSoftware/vollo-sdk/releases/download/v28.1.0/vollo-amd-v80ll-c6b32-28.1.tar.gz
mkdir -p $VOLLO_SDK/bitstream
